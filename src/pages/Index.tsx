        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-6">
            ...
            <p className="text-lg text-muted-foreground leading-relaxed">
              ООО "Рубцовский продукт" — ведущий производитель мясных полуфабрикатов и колбасных изделий. Мы заслужили доверие тысяч покупателей благодаря неизменно высокому качеству продукции.
            </p>
            <p className="text-lg text-muted-foreground leading-relaxed">
